...
function ScrollingTextBanner() {
  ...
  const x = useTransform(scrollYProgress, [0, 1], ["70%", "-170%"]);
        ...
        <section id="hero" className="fixed inset-0 flex items-center justify-center overflow-hidden bg-background p-2 sm:p-4 lg:p-6">
          ...
          <div className="relative z-10 text-center px-6">
            ...
            >
              See the Sky
              <br />
              <span className="italic font-extralight">as It Truly Was</span>
            </motion.h1>
            ...
            >
              Astrology mapped to the real positions of the stars.
            </motion.p>
